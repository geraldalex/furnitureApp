...
onPress={() => console.log("Serch on clicked")}
>
<Image 
source={icons.search}
resizeMode='contain'
...
Furniture
    ...
    <Text style={{color:COLORS.white, ...FONTS.h1, marginTop:SIZES.radius}}>
{itemInfo.productName}
    </Text>
</View>
...
function renderFooter() {
    return(
        <View style={{
            position:'absolute',bottom:'5%', left:SIZES.padding, right: SIZES.padding,flexDirection:'row',
            height:70, backgroundColor:COLORS.white, borderRadius:35
